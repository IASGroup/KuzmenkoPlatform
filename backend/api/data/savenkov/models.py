...
class Percentage:
    def __init__(self):
        path = f'{PATH}/csv/files/percentageTrigramsArticlesInCategory.csv'
...
def plot_clustering_count_n_grams_in_category() -> str:
    path = f'{PATH}/json/files/plot_clustering_count_n_grams_in_category.json'
    with open(path, "r") as file:
        json_data = json.load(file)
